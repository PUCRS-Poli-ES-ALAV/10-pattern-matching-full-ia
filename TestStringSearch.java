public class TestStringSearch {
    ...
    public static void main(String[] args) {
        ...
        // Teste 2: Strings de tamanhos crescentes
        testePerformance();
        
        // Teste 3: Análise de complexidade - Pior caso
        testePiorCaso();
    }
    ...
    private static void testePerformance() {
        ...
        for (int size : sizes) {
            ...
            // Gerar strings: padrão no final (pior caso relativo)
            ...
            // Força Bruta (apenas para tamanhos menores)
            if (size <= 100_000) {
                System.out.println("  Força Bruta: " + StringSearch.forcaBruta(s1, s2));
            } else {
    ...
    private static void testePiorCaso() {
        ...
        for (int size : sizes) {
            ...
            // Pior caso: todos 'A' e buscar padrão 'AAAB' (não existe)
            ...
            // Força Bruta (apenas para tamanhos pequenos)
            if (size <= 50_000) {
                System.out.println("  Força Bruta: " + StringSearch.forcaBruta(s1, s2));
            } else {
